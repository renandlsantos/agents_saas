...
export const OFFICIAL_URL = 'https://agentssaas.com';
export const OFFICIAL_PREVIEW_URL = 'https://chat-preview.agentssaas.com';
export const OFFICIAL_SITE = 'https://agentssaas.com';

export const OG_URL = '/og/cover.png?v=1';

export const GITHUB = pkg.homepage;
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://agentssaas.com/changelog';
export const DOCKER_IMAGE = 'https://hub.docker.com/r/agentssaas/agents-chat';
...
export const PLUGINS_INDEX_URL = 'https://plugins.agentssaas.com';

export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/agentssaas/agents-chat/discussions/6157';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/agentssaas/agents-chat/discussions/3684';

export const AGENTS_INDEX_GITHUB = 'https://github.com/agentssaas/agents-chat-agents';
...
export const BASE_PROVIDER_DOC_URL = 'https://agentssaas.com/docs/usage/providers';
