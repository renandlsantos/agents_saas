...
## Dependencies layer - separada para melhor cache
FROM base AS deps
...
# Node - aumentar para builds grandes
...
# Build com cache mount para .next/cache
RUN --mount=type=cache,target=/app/.next/cache \
    pnpm run build:docker

## Application image otimizada
...
# Model Variables - todos os modelos como no original
ENV \
    # AI21
